...
export default function Banner({
  ...
  return (
    <div
      className={`w-full h-[200px] md:h-[250px] bg-gradient-to-r from-[#003E81] to-[#367AC4] flex flex-col justify-center items-center px-4 sm:px-8 md:px-24 lg:px-36 ${className}`}
    >
